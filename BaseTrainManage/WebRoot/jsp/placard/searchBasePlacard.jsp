...
<html>
  <head>
    ...
    <script type="text/javascript" src="../../js/menuchoose.js"></script>
		...
		<script type="text/javascript" src="../../js/placard/searchBasePlacard.js"></script>
  ...
  <body>
  	<div class="list" id="editPlacard">
	  	<div class="topContent">
	  		...
	  		<span>公告类型：
	 	 		<select id="search_placard_type">
	 	 			<option value=''>请选择公告类型</option>
	 	 			<option value='1'>基地公告</option>
   ...
   <div class="list " id="skinInfo" style="display:none">
 	 <div  class="modifyInfo schoolPlacardInfo">
 	 		<span>公告类型：
 	 		<select id="placard_type">
 	 			<option value='1' id="placard_type1">基地公告</option>
 	 			<option value='3' id="placard_type2">常见问题</option>
 	 		</select>
 	 		</span>
			<br/><br>
