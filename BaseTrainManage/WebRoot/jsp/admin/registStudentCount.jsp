		...
		<script type="text/javascript">
			...
			function Count(){
				...
				if(countType == 1){
					...
					$.ajax({
		  			url:"/BaseTrainManage/student/registCountByMajor.do",
						type:"post",
						dataType:"json",
					...
					$("#showInform thead").append($(tr));
					$.ajax({
		  			url:"/BaseTrainManage/student/registCountByBase.do",
						type:"post",
						dataType:"json",
						success:function(result){
							if(result.status == 1){
					...
					$("#showInform thead").append($(tr));
					$.ajax({
		  			url:"/BaseTrainManage/student/registCountByMajorAndBase.do",
						type:"post",
						dataType:"json",
						success:function(result){
							if(result.status == 1){
