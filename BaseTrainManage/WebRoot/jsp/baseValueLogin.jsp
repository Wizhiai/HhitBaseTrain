			...
			<DIV
				...
				<P style="margin: 0px 35px 20px 45px;">
					...
					<SPAN style="float: left;"><A
						style="color: rgb(204, 204, 204);" >用户类型&nbsp;<select id = "type" >
						<option value = "stu"/>学生
						<option value = "teach"/>教师
						<option value = "admin"/>管理员
						<option value = "zj"/>专家
						<option value = "ass"/>被评单位
						</select></A></SPAN> 
						
						
						 <SPAN
						style="float: right" style="margin: 0px 35px 20px 45px;">
						<input type="submit" value="登录" id="login" /></SPAN>
				</P>
			</DIV>
	</DIV>
	</form>
