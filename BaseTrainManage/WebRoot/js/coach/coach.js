 			    	...
 			    	if(result.status!=0){
 			    	    ...
 			    	    if(currentpage==pagecounts){
 			    	    	for(var i=0;i<courses.length;i++){
 			    	    		var id=courses[i].id;
 			            		var fileName=courses[i].studydata;
 	 			    	 	 ...
 	 			    	 	 tr+='<img  src="../image/look.png"/>';
 	 			    	 	   tr+='<td><a href="../download.do?fileName='+fileName+'">查看课辅资料</a>&nbsp;';
 	 			 				tr+='<img  src="../image/delete.png"/>';
 	 			 				tr+='<a href="JDT_modifyStudyData.html?id='+id+'&fileName='+fileName+'">删除课辅资料</a>&nbsp;</td></tr>';
 			    	 			$tr=$(tr);
