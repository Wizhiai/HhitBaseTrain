 function setpageSize(){
 		...
 		$.ajax({
 		        url:"http://localhost:8080/BaseTrainManage/trainstudent/searchgradebyconditionPage.do",
 			    type:"post",
 			    	...
 			    	if(result.status!=0){
 			    	    ...
 			    	    if(currentpage==pagecounts){
 			    	    	for(var i=0;i<grades.length;i++){
 			    	    		var id=grades[i].id;
 			    	    		var stu=grades[i].stuno;
 			    	 	        var name=grades[i].stu_name;
 			    	 	        var base_name=grades[i].base_name;
 			    	 	    ...
 			    	 	    tr+='<td><img alt="修改" src="../image/update.png">';
 			    	 		tr+='<a href="JDT_modifyGradeInfo.html?id='+id+'&stuno='+stu+'&name='+name+'&base_name='+base_name+'&month='+month1+'&week='+week1+'&grade='+grade+'"> 修改</a>&nbsp;&nbsp;<img alt="删除" src="../image/delete.png"><a href="JDT_modifyGrade.html?id='+id+'"> 删除</a></td></tr>';
	 			    	 	    $tr=$(tr);
 ...
 function deletegrade(){
	 alert(id);
	 $.ajax({
		 url:"http://localhost:8080/BaseTrainManage/baseteacher/deletegrade.do",
		 type:"post",
		 data:{"id":id},
		 dataType:"json",
		 success:function(result){
