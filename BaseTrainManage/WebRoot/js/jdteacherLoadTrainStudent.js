 ...
 function setpageSize(){
 		...
 		$.ajax({
 			    ...
 			    type:"post",
 			    data:{"t_no":t_no,"page":page,"pageSize":pagesize,"stuname":stuname},
 			    dataType:"json",
 			    	...
 			    	if(result.status!=0){
 			    	    ...
 			    	    if(currentpage==pagecounts){
 			    	    	for(var i=0;i<students.length;i++){
 			    	 	    ...
 			    	 	    tr+='  <td><a onclick="toNextPage();">统计</a></td>';
 			    	 	    $tr=$(tr);
 			    	 	  // $tr.data=("stuno",stu);
 ...
 function toNextPage(){
	  window.location.href="JDT_countGradeInfoBymonth.html?stuno="+stu+"&cno="+cno;
