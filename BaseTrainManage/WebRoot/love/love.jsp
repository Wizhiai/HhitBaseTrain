...
<body>
<embed src="music/music2love.mp3" width="0" height="0" border=0 autostart="ture" loop="ture" type="audio/mpeg"></embed>
	...
	<div id="mainDiv">
		<div id="content">
			<div id="code">
				...
				Boy I = <span class="keyword">new</span> Boy(<span class="string">"L.Z.Q"</span>);<br />
				Girl U = <span class="keyword">new</span> Girl(<span class="string">"x.b.c?"</span>);<br />
		...
		<div id="copyright">
			Copyright © 2014 <a href='http://www.ikey4u.com/'>KillerLegend</a>
		</div>
	</div>
	<script type="text/javascript">
		...
		together.setFullYear(2014, 11, 16);//这里设置你们成为情侣的开始时间
		together.setHours(0);
