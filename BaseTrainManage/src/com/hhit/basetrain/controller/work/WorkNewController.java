 ...
 */
@Controller
public class WorkNewController {
	@Resource
	private WorkService workService;
	
	@RequestMapping("work/shownewwork")
	@ResponseBody
	public Result execute(String stuno, String base_class,
			Integer base_no, Integer page, Integer pageSize, String currentDate){
		Result result=workService.searchUnfinishedWork(stuno, base_class, base_no, page, pageSize, currentDate);
